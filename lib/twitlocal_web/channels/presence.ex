defmodule TwitlocalWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Twitlocal.MyChannel do
        use TwitlocalWeb, :channel
        alias TwitlocalWeb.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :twitlocal,
                        pubsub_server: Twitlocal.PubSub
end
